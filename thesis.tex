\documentclass{beavtex_dub_edit}
\usepackage{graphicx}
\usepackage{rotating} 
...
%TODO: Figure caption shorter versions
\begin{document}
\maketitle
\mainmatter
...
\begin{figure}
    \includegraphics[width = 1\textwidth]{graphene theory 0}
    \caption[Filling of electronic states in graphene at zero temperature for (a) $E_F >0$, (b) $E_F = 0$, and (c) $E_F < 0$.]{Filling of electronic states in graphene at zero temperature for (a) $E_F >0$, (b) $E_F = 0$, and (c) $E_F < 0$. Filled electronic states are indicated in blue. Unfilled electronic states in the valence band (holes) are indicated in red.}
...
\begin{figure}
    ...
    \caption[A surface acoustic wave traveling in a bulk piezoelectric material.]{A surface acoustic wave traveling in a bulk piezoelectric material. The SAW amplitude $|\phi_{SAW}|$ is well-known to decay approximately exponentially into the surface, with most of its energy contained within a depth $1/k$ \cite{wixforth_surface_1989}.}
    \label{SAWbulksemi}
\end{figure}
...
\begin{figure}
    \includegraphics[width = 0.6\textwidth]{transfer stage image.pdf}
    \caption[An image of our transfer stage (purchased from HQ Graphene).]{An image of our transfer stage (purchased from HQ Graphene). A substrate containing a 2D sample is placed in-between the microscope objective and viscoelastic stamp. Using motorized stages, the stamp is used to pick up and stack 2D flakes. Heating the stage increases the stickiness of the stamp.}
...
\begin{figure}
    ...
    \caption[h-BN flake transferred onto LiNbO\textsubscript{3} before (top) and after (bottom) photolithography process to deposit metal electrodes on top of the h-BN. The h-BN lifted off with the deposited metal.]{h-BN flake transferred onto LiNbO\textsubscript{3} before (top) and after (bottom) photolithography process to deposit metal electrodes on top of the h-BN. The h-BN lifted off with the deposited metal. Scale bar = \SI{40}{\micro\meter}.}
...
\begin{figure}
    ...
    \caption[Optical microscope image of a pair of IDTs on black LiNbO\textsubscript{3} with parameters $N_p = 20$, $W = \SI{230}{\micro\meter}$, and $\lambda = \SI{20}{\micro\meter}$.]{Optical microscope image of a pair of IDTs on black LiNbO\textsubscript{3} with parameters $N_p = 20$, $W = \SI{230}{\micro\meter}$, and $\lambda = \SI{20}{\micro\meter}$. Scale bar = $\SI{100}{\micro\meter}$.}
...
\begin{figure}
    \includegraphics[width = 1\textwidth]{Figure 1 overview.png}
...
\begin{figure}
    ...
    \caption[Mixed-carrier model (Eq.\ \ref{AECP Equation 7}) fit to acoustoelectric transport in the fully encapsulated (a) and half-encapsulated (b) graphene devices.]{Mixed-carrier model (Eq.\ \ref{AECP Equation 7}) fit to acoustoelectric transport in the fully encapsulated (a) and half-encapsulated (b) graphene devices. This data is taken with $P_{\mathrm{RF}} = \SI{18}{\milli\watt}$.}
    \label{AECP Figure 4}
\end{figure}
...
\begin{figure}
    ...
    \caption[The interferometer setup used to measure the reflectance of a sample.]{The interferometer setup used to measure the reflectance of a sample. Incident wavelength is scanned using a Labview-controlled monochromator and plotted against measured reflected power. The colors indicate incident light (red) and reflected light (blue).}
    \label{InterfSpec}
\end{figure}
...
\begin{figure}
    \includegraphics[width = 1\textwidth]{Flip-chip diagram.pdf}
