...
Why do quantum materials matter? Is there a point to studying them? Are all of these new physics phenomena just toys, or can they be useful? Relate this to the first quantum revolution


Interest in the transformative potential of the second quantum revolution has reached the mainstream. Not a week goes by without a thousand popular science articles promising that some new material, with some "weird quantum property", will enable scalable quantum computers that revolutionize your computer, car, refrigerator, and more. Central to these claims are quantum materials, or those whose properties go beyond silicon. In quantum materials, electrons are strongly interacting, quantum interference effects arise, new quantum degrees of freedom can be harnessed, and topological states of matter challenge our understanding of physics. But, can these materials revolutionize anything, or are they just curiosities that will never leave the lab?

Few classes of materials have captivated researchers' interest as profoundly as two-dimensional (2D) materials, a subset of quantum materials. Nearly two decades since the Nobel Prize was awarded for electronic measurements of atomically-thin carbon films known as graphene, the family of 2D materials has expanded to include a plethora of 2D semiconductors and magnets with surprising new phenomena. 

2D materials are very tunable.

https://www-nature-com.oregonstate.idm.oclc.org/articles/nature22391

2D magnets are approaching room-temperature applications




Electrons are strongly interacting
Quantum interference effects
New quantum degrees of freedom (e.g. valley degree of freedom)
Topological physics



Quantum materials command a central focus in today’s research landscape. Excitement about quantum information science 


Quantum materials . These materials, which encompass a diverse family of two-dimensional (2D) semiconductors, hold the potential to revolutionize our understanding of the quantum world and herald the next generation of computing. 




Few classes of materials have captivated researchers' interest as profoundly as two-dimensional (2D) materials. Nearly two decades since the Nobel Prize was awarded for measurements of atomically-thin carbon films known as graphene, the family of 2D materials has expanded to include a plethora of 2D semiconductors and magnets


a plethora of two-dimensional (2D) materials 

has promised to revolutionize physics, thanks to its unique properties. Its extraordinary thermal conductivity, mechanical strength, and, most importantly, its unusual electronic band structure have opened new avenues for exploring quantum phenomena. This dissertation embarks on a journey to probe these quantum phenomena using surface acoustic waves (SAWs), an innovative approach that marries the macroscopic world of acoustics with the microscopic realm of quantum mechanics. As we delve into the heart of 2D materials with the rhythm of SAWs, we stand on the brink of uncovering new physics, promising not only to enrich our understanding of the universe but also to propel us into a future where the quantum world is within our grasp. This is not just a study—it’s an exploration of the quantum frontier.
...
\subsection{Making the viscoelastic stamp}
...
\subsection{The hot pickup process}
...
\section{Cleaning electrodes with contact-mode AFM} \ref{AFM cleaning main section}
...
For this process, I use Tap150AL AFM probes (Budget Sensors) and an MFP-3D AFM. I first measure the exact spring constant of the AFM tip by taking a force curve. For the full force curve process and a sample force curve, see Appendix \ref{force curve appendix}. Then, I scan the AFM across the electrodes at a force of \SI{150}{N} and a speed of \SI{150}{\micro\meter/\second}. The AFM scan size is \SI{35}{\micro\meter} in the scan direction, and the Tap150AL tip has a minimum diameter of \SI{10}{\nano\meter}. I chose 3584 lines for the scan (\SI{9.76}{\nano\meter/line}) to ensure that each line slightly overlaps the previous line. Figure \ref{AFM cleaning points} shows Pd electrodes after AFM cleaning. Although the metal appeared residue-free before cleaning, a significant amount of residue is now visible at the scan edges. I use this process in Ch. \ref{AE charge pumping paper} to clean pre-patterned Pd electrodes before transferring graphene onto them.

\begin{figure}
    \includegraphics{AFM cleaning 1.pdf}
    \caption{An optical microscope image of Pd electrodes on LiNbO\textsubscript{3} after AFM cleaning at \SI{150}{N} and \SI{150}{\micro\meter/\second}. Scale bar = \SI{40}{\micro\meter}.}
    \label{AFM cleaning points}
\end{figure}


\section{Electron-beam lithography} \label{electron-beam lithography}
