...
\end{equation}
where $k_B$ is Boltzmann's constant and $T$ is temperature. I take $E_F = 0$ to reflect charge neutral graphene. Figure \ref{graphene at elevated T plot} illustrates
...
\end{equation}
for the time-varying sheet conductivity in the hole-transport case. Finally, the DC acoustoelectric current density becomes
...
\section{Cleaning electrodes with contact-mode AFM}
