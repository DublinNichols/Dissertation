...
% \begin{figure}
%     \centering
%     \includegraphics[width = 0.8\textwidth]{graphene layer comparison.pdf}
...
% \begin{figure}
%     \includegraphics[width =  0.8\textwidth]{Figure 3 n and p_corrected.png}
...
% \begin{figure}
%     \includegraphics[width = 1\textwidth]{Vg at which vae is max or min.png}
